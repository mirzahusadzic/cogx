...
**Day 6-8**: SDK Layer
- [ ] Create `src/tui/hooks/sdk/useSDKQuery.ts`
- [ ] Create `src/tui/hooks/sdk/useSDKMessageHandler.ts`
- [ ] Write comprehensive tests
- [ ] Replace in `useClaudeAgent.ts`
- [ ] Verify in TUI

**Day 9-10**: Rendering Layer
- [ ] Create `src/tui/hooks/rendering/MessageRenderer.ts`
- [ ] Create `src/tui/hooks/rendering/ToolFormatter.ts`
- [ ] Write comprehensive tests
...
### Code Quality
- **Lines**: useClaudeAgent.ts = 1,790 lines (will become 150)
- **Test Coverage**: 0% (will become 95%+)
- **Modules**: 1 monolith (will become 15 focused modules)
