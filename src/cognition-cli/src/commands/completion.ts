...
_cognition_cli_completions() {
  ...
  case "\${cmd_with_colon}" in
    ...
    --model)
      ...
      COMPREPLY=( $(compgen -W "claude-opus-4-5-20251101 claude-sonnet-4-5-20250929 gemini-3-flash-preview gemini-3-pro-preview gemini-2.5-flash gemini-2.5-pro gemini-2.0-flash gemini-2.0-flash-thinking-exp-01-21 gpt-oss-20b" -- \${cur}) )
      return 0
      ;;
    overlay)
      ...
      case $words[1] in
        tui)
          _arguments -C \
            ...
            '--model[Model to use]:model:(claude-opus-4-5-20251101 claude-sonnet-4-5-20250929 gemini-3-flash-preview gemini-3-pro-preview gemini-2.5-flash gemini-2.5-pro gemini-2.0-flash gemini-2.0-flash-thinking-exp-01-21 gpt-oss-20b)' \
...
complete -c cognition-cli -n "__fish_seen_subcommand_from tui" -l model -d "Model to use" -xa "claude-opus-4-5-20251101 claude-sonnet-4-5-20250929 gemini-3-flash-preview gemini-3-pro-preview gemini-2.5-flash gemini-2.5-pro gemini-2.0-flash gemini-2.0-flash-thinking-exp-01-21 gpt-oss-20b"
