...
export function createRecallMcpServer(
  ...
  const recallTool = tool(
    ...
    'Retrieve FULL untruncated messages from conversation history. Use this tool to get complete details about past discussions. Searches all 7 overlays (O1-O7) in LanceDB with semantic search. Ask about topics, not exact phrases.',
    {
      query: z
        .string()
        .describe(
