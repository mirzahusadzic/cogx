...
2. **[Quick Start](getting-started/quick-start.md)** — Get up and running fast
3. **[Introduction](getting-started/introduction.md)** — Learn core concepts
...
- [VISION](research/vision.md) — Mission and strategic intent
